      ...
      "children": [
        {
          ...
          "name": "인사",
          "items": [
            { "id": "first-greeting", "name": "첫인사", "full_name": "스크립트 첫인사 내용대로 발화", "type": "NLP", "default_score": 6, "description": "안녕, 무신사, 서포터 중 포함 여부 확인", "criteria": [{"score": 6, "label": "정상", "desc": "스크립트 인사 발화 포함"}, {"score": 0, "label": "감점", "desc": "첫인사 누락 또는 미흡"}], "used_in": ["I/B 일반 상담 평가표 v2.1", "I/B VIP 평가표 v1.0"], "score_type": "deduction", "is_active": true },
            { "id": "last-greeting", "name": "끝인사", "full_name": "스크립트 끝인사 내용대로 발화", "type": "NLP", "default_score": 6, "description": "마무리 인사 발화 포함 여부 확인", "criteria": [{"score": 6, "label": "정상", "desc": "끝인사 발화 포함"}, {"score": 0, "label": "감점", "desc": "끝인사 누락"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true }
          ]
        },
        {
          "id": "reply-greeting",
        ...
        },
        {
          ...
          "name": "말겹침",
          "items": [
            { "id": "simultaneous-speech", "name": "동시 발화", "full_name": "동시 발화가 이루어지지 않게 함", "type": "NLP", "default_score": 6, "description": "상담사와 고객의 동시 발화 발생 시 대처 방식 평가", "criteria": [{"score": 6, "label": "정상", "desc": "말겹침 후 사과/배려 표현"}, {"score": 4, "label": "경미", "desc": "겹침 후 일시 멈춤"}, {"score": 0, "label": "심각", "desc": "상담사 발화 지속(덮어씀)"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true }
          ]
        },
        {
          "id": "no-response",
          "name": "무응답",
          "items": [
            { "id": "no-acknowledge", "name": "양해 없는 무응답", "full_name": "고객 양해 없는 무응답 방지", "type": "NLP", "default_score": 5, "description": "15초 이상 무응답 시 양해 멘트 유무 평가", "criteria": [{"score": 5, "label": "정상", "desc": "15초 미만 또는 양해 멘트 3개"}, {"score": 2, "label": "경미", "desc": "15초↑ 무응답, 양해 멘트 ≤1개"}, {"score": 0, "label": "심각", "desc": "15초↑ 무응답, 양해 멘트 없음"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true }
          ]
        },
        {
          "id": "fail",
          "name": "FAIL",
          "items": [
            { "id": "profanity", "name": "욕설/금지어", "full_name": "욕설, 금지어 표현 일체", "type": "NLP", "default_score": 0, "is_fail": true, "description": "욕설, 금지어, 비속어, 한숨/짜증 표현 탐지 시 전 항목 0점 처리", "criteria": [{"score": 0, "label": "FAIL", "desc": "탐지 시 전 항목 0점"}, {"score": 0, "label": "PASS", "desc": "미검출 - 정상 평가 유지"}], "used_in": ["I/B 일반 상담 평가표 v2.1", "I/B VIP 평가표 v1.0", "O/B 텔레마케팅 평가표 v1.3"], "score_type": "deduction", "is_active": true }
          ]
        },
        {
          ...
          "name": "전문적 상담 태도",
          "items": [
            { "id": "interruption", "name": "말끊기", "full_name": "상담원의 의도적인 말겹침", "type": "NLP", "default_score": 5, "description": "고객 발화 중 상담원 개입으로 인한 발화 중단 평가", "criteria": [{"score": 5, "label": "정상", "desc": "정상 청취"}, {"score": 0, "label": "감점", "desc": "고객 발화 중단 → 5초↑ 무발화"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true },
            ...
            { "id": "speech-ending", "name": "상담 어미", "full_name": "전문적인 상담 어미", "type": "NLP", "default_score": 5, "description": "공손한 종결 어미 사용 여부 평가 (~습니다, ~세요 등)", "criteria": [{"score": 5, "label": "정상", "desc": "공손한 종결 어미 사용"}, {"score": 0, "label": "감점", "desc": "비격식 발화 ≥3회"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true },
            { "id": "professional-speech", "name": "전문적 화법", "full_name": "전문적인 상담 화법", "type": "NLP", "default_score": 5, "description": "비언어 발화(어, 음) 및 비전문적 호응(네네네) 빈도 평가", "criteria": [{"score": 5, "label": "정상", "desc": "비언어 <5회 AND 비전문적 <3회"}, {"score": 4, "label": "경미", "desc": "비전문적 호응 ≥3회"}, {"score": 2, "label": "중간", "desc": "비언어 ≥5회"}, {"score": 0, "label": "복합", "desc": "비언어 ≥5회 AND 비전문적 ≥3회"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true },
            ...
            { "id": "convenience", "name": "편리(재질의)", "full_name": "고객 정보 재질의 금지", "type": "NLP", "default_score": 5, "description": "이름/연락처/인입사유 중복 질의 여부 평가", "criteria": [{"score": 5, "label": "정상", "desc": "재질의 없음"}, {"score": 0, "label": "감점", "desc": "중복 질의 1회 이상"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true },
            { "id": "speed", "name": "신속성", "full_name": "신속한 응대", "type": "NLP", "default_score": 5, "description": "상담사 응답 지연 시간 평가", "criteria": [{"score": 5, "label": "정상", "desc": "1.0초 이내 응답"}, {"score": 2, "label": "경미", "desc": "1.0~3.0초 지연"}, {"score": 0, "label": "중대", "desc": "3.0초 이상 지연"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true },
      ...
      "children": [
        {
          ...
          "name": "개인정보처리방침",
          "items": [
            { "id": "required-privacy", "name": "개인정보 확인", "full_name": "필수 개인 정보 확인", "type": "NLP", "default_score": 5, "description": "구매자명, 연락처, 본인 여부 3가지 확인 수행", "criteria": [{"score": 5, "label": "정상", "desc": "필수 항목 3개 모두 수행"}, {"score": 0, "label": "감점", "desc": "0~2개만 수행"}], "used_in": ["I/B 일반 상담 평가표 v2.1"], "score_type": "deduction", "is_active": true }
          ]
        },
        {
          "id": "resolution",
